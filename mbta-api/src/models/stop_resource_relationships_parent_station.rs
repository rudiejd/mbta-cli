...
pub struct StopResourceRelationshipsParentStation {
    ...
    pub links: Option<Box<crate::models::StopResourceRelationshipsParentStationLinks>>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::StopResourceRelationshipsParentStationData>>,
}
