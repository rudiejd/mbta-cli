...
pub struct RoutePatternResourceRelationshipsRepresentativeTrip {
    ...
    pub links: Option<Box<crate::models::RoutePatternResourceRelationshipsRepresentativeTripLinks>>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::RoutePatternResourceRelationshipsRepresentativeTripData>>,
}
